          ...
          {!submitted ? (
            <form onSubmit={handleSubmit} className="flex items-center gap-2 max-w-sm">
              <input
                ...
                className="flex-1 h-10 px-3 rounded bg-white/[0.06] border border-white/10 text-sm text-white placeholder:text-white/25 outline-none focus:border-white/25 transition-colors"
              />
              <button
                type="submit"
